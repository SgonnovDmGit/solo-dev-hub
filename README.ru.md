...
- **v1.2.0** *(текущий — 2026-06-02)* — портфельный отчёт по деплоям (все deploy-окружения в одном экране, по проектам, с drill-down), managed-шаблон `.gitattributes`, плюс фиксы кастомного периода Дашборда и per-repo черновика секретов.
...
- **v1.3.0** — in-app мультиязычный help-экран документирующий LLM operating contract.
