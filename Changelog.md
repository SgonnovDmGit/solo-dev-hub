...
### Added
- **T-000084 | GitHub repo description + topics** — public-launch SEO/discovery preparation: `gh repo edit --description "..."` (short marketing tagline matching README hero) and `gh repo edit --add-topic tauri,svelte,sveltekit,rust,project-management,github,solo-developer,indie-dev,bug-tracker,deploy-automation`. Topics work even on a private repo; they become visible only after the public flip (T-000064 in v1.0.0).
