...
### Tests
- 375 cargo (+5 новых для `sync::confirm_pair`: client→server, server→MS happy paths, sibling-NNN disambig invariant от v0.27.1 сохранён, unknown source role errors out, missing local_path silent no-op) / 72 vitest / 0 svelte issues на 495 файлах.
